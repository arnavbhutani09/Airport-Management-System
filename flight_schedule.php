...
<center><table><tr><td><a href="flight_schedulei.php"><button style="padding: 5px">ADD</button><br><br></td>
<td><a href="flight_schedule_report.php"><button style="padding: 5px">REPORTS</button><br><br></td></tr></table></center>
</body></html>