...
while($record=mysql_fetch_array($data)){
	...
	echo "<td><a onClick=\"javascript: return confirm('Are you sure to delete this entry ?');\" href='flight_master_delete.php?flight_id=".urlencode($record["flight_id"])."'> <img src=\"delete_icon.jpg\"> </a></td>";
...
<center><table><tr><td><a href="flight_masteri.php"><button style="padding: 5px">ADD</button><br><br></td>
<td><a href="flight_master_report.php"><button style="padding: 5px">REPORTS</button><br><br></td></tr></table></center>
