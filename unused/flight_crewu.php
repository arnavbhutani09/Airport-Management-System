...
<fieldset><legend>Flight_Crew: Update</legend>
...
<label>Current Crew Id: </label><select name= "member_id">
<?php
$con=mysql_connect("localhost","root","") or die(mysql_error()+" occurs");
mysql_select_db("airline",$con) or die(mysql_error()+" occurs");
...
<label>Current Source Airport Id: </label><select name= "dep_airport_id">
<?php
$con=mysql_connect("localhost","root","") or die(mysql_error()+" occurs");
mysql_select_db("airline",$con) or die(mysql_error()+" occurs");
...
<option value="departure_date">Date of departure</option></select><br><br>
...
if($_POST)
{
		...
		$new=$_POST["new"];
		$query="update flight_crew set ".$attribute."=\"".$new."\" where flight_id=\"".$flight_id."\"and member_id=\"".$member_id."\"and dep_airport_id=\"".$airport_id."\";";
