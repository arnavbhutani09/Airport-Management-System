...
if($_POST)
{
	...
	//{
		...
		*/
		$query="update airport set location='$location', airport_name='$airport_name', runways=$runways, status='$status' where airport_id='$airport_id'";
...
echo "&nbsp;&nbsp;&nbsp".$airport_id;
?>
>
<br><br><br>

<label>Aiport Name : </label>
<input type="text" name="airport_name" readonly value=<?php
$airport_name = $_GET['airport_name'];
echo "&nbsp;&nbsp;&nbsp".$airport_name;
?>
>
<br><br><br>
